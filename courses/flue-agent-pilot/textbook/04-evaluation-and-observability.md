...
> Lab 适配说明（2026-09-11）：将末尾导航改为平台内已声明章节，保留教材正文与代码。
...
下一步：回到[学习目标与路线](../overview.md)复查目标；完成 [L1](../lab-manual/01-trace-an-agent.md)、[L2](../lab-manual/02-build-a-skill.md) 与 [L3](../lab-manual/03-choose-capability-boundaries.md)。准备好自备账号与目标环境授权后，再选择 [L4 技能激活](../lab-manual/optional/04-activate-and-observe.md)或 [L5 Agent eval](../lab-manual/optional/05-evaluate-an-agent.md)。
